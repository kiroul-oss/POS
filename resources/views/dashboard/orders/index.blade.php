                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('dashboard.orders.update_status', $order->id) }}" method="GET">
                                                <button type="submit" class="btn {{ $order->status == '0' ? 'btn-warning' : 'btn-success disabled' }} btn-sm">
